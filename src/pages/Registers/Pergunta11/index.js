  ...
  useEffect(() => {
    ...
    if (isSelected1 == false  && isSelected2 ==false && isSelected3 ==false && isSelected4 ==false && isSelected5 ==false){
      ...
      setResposta5('') 
        ...
        setIsDisable4(true)
        setIsDisable5(false)
        setResposta5 ('Não estou nesta lista')
    ...
    if(isSelected1){
      setResposta1('Sou voluntário dentro de comunidades carentes')
    }else{ setResposta1('')}
    if(isSelected2){
      setResposta2('Sou voluntário em serviços de armazenamento')
    }else{ setResposta2('')}
    if(isSelected3){
      setResposta3('Sou voluntário em serviços internos')
    }else{ setResposta3('')}
    if(isSelected4){
      setResposta4('Trabalho em creches, asílos ou similares')
    }else{ setResposta4('')}
...
_storeData = async () => {
   ...
   try{
  await AsyncStorage.setItem(keys.questionario.Q11, JSON.stringify(respostas))
  const save = await AsyncStorage.getItem(keys.questionario.Q11)
  if(!save){
  ...
  return (
    <View style={styles.container}>
     ...
     <Text style={styles.titles} >Você está fazendo trabalho voluntário?</Text>
     ...
     <View style={styles.alternatives}>
        ...
        />
        <Text >Sou voluntário dentro de comunidades carentes</Text>
      </View>
      ...
      <View style={styles.alternatives}>
        ...
        />
       <Text >Sou voluntário em serviços de armazenamento </Text>
      </View>
      ...
      <View style={styles.alternatives}>
        ...
        />
       <Text >Sou voluntário em serviços internos</Text>
      </View>
      ...
      <View style={styles.alternatives}>
        ...
        />
       <Text >Trabalho em creches, asilos ou similares </Text>
      </View>
      <View style={styles.alternatives}>
        <CheckBox
           disabled={isDisable5}
